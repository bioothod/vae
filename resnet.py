...
class BaseV2(tf.keras.layers.Layer):
    def __init__(self, **kwargs):
        ...
        self.max_pooling0 = tf.keras.layers.MaxPooling(pool_size=3, strides=2, padding='same')
...
class BlockV2(tf.keras.layers.Layer):
    def __init__(self, channels_in, kernel_size, stride=1, conv_shortcut=False, **kwargs):
        ...
        self.conv2 = tf.keras.layers.Conv2D(channels_out, kernel_size=1, stride=1, padding='same')
